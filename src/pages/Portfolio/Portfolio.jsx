    ...
    <br/>
      <div className="container">
        <div className="row">
          ...
          <div className="col s6">
              <img src={empDir} alt="blah" height="500px" style={{border:"1px solid #000000"}} />
          </div>
        </div>
      </div>
      <br/>
      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col s6">
              <img src={safeMusic} alt="blah" height="500px" style={{border:"1px solid #000000"}} />
          </div>
        </div>
      </div>
      <br/>
      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col s6">
              <img src={footOrFut} alt="blah" height="500px" style={{border:"1px solid #000000"}} />
          </div>
        </div>
      </div>
    </>
